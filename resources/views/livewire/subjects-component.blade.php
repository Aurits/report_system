                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="subjects.html" class="btn btn-outline-gray me-2 active"><i class="feather-list"></i></a>
                                        <a href="subjects-grid.html" class="btn btn-outline-gray me-2"><i class="feather-grid"></i></a>
                            ...
                            <div class="table-responsive">
                                <table class="table border-0 star-subject table-hover table-center mb-0 datatable table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="actions">
                                                    ...
                                                    <a href="edit-subject.html" class="btn btn-sm bg-danger-light"><i class="feather-edit"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <!-- Add more subject rows as needed -->
                                    </tbody>
                                </table>
                            </div>
                        </div>
